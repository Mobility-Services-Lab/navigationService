        ...
        return {
            ...
            link: function (scope, element, attrs, controllers) {
                ...
                var template = [
                    ...
                    '<input type="search" class="ion-autocomplete-search" ng-enter="viewModel.cancelClick()" ng-model="viewModel.searchQuery" ng-model-options="viewModel.ngModelOptions" placeholder="{{viewModel.placeholder}}"/>',
                    '</label>',
